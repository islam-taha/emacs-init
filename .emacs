(custom-set-faces
 ...
 '(mode-line ((t (:inherit nil :background "#e1e1e1" :foreground "#414141" :overline nil :underline nil :height 0.98))))
 '(term ((t (:inherit t)))))
...
(add-to-list 'load-path "~/.emacs.d/elpa/popup-20151125.542")
...
(global-set-key (kbd "C-M-y") 'helm-M-x)
...
(add-to-list 'load-path "~/.emacs.d/lisp/company-20151221.513/");
(require 'company)
;;(rbequire 'company-emacs-eclim)
...
(setq package-list '(adaptive-wrap airline-themes powerline angular-mode atom-one-dark-theme bbdb-handy bbdb bison-mode color-theme color-theme-modern company-irony irony company darcula-theme dracula-theme ecb emms-soundcloud emms emoji-cheat-sheet-plus helm helm-core async async epc ctable concurrent deferred fancy-battery find-file-in-project swiper flx-ido flx flycheck seq let-alist pkg-info epl dash flymake-ruby flymake-easy fsm git-gutter gnus-desktop-notify google-maps helm-anything anything helm helm-core async async helm-core async hlinum iedit irony kite websocket mark-multiple mmm-mode multi-term multiple-cursors nasm-mode org-gcal org alert log4e gntp request-deferred request deferred paper-theme hexrgb paradox hydra spinner let-alist seq pdf-tools let-alist tablist popup powerline railscasts-theme robe inf-ruby seq skewer-mode js2-mode simple-httpd smooth-scroll smooth-scrolling solarized-theme dash soundcloud request-deferred request deferred request string-utils list-utils deferred emms soundklaus pkg-info epl s deferred emms dash speed-type spinner string-utils list-utils sublime-themes swiper switch-window tabbar-ruler tabbar tablist tabula-rasa tommyh-theme twilight-bright-theme w3 w3m websocket windresize zenburn-theme))
...
;; (load-file "~/.emacs.d/mac-classic.el")
